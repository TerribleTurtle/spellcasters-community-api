...
3.  **Patch History (Automatic):**
    ...
    - The pipeline runs `generate_patch.py` → `build_changelogs.py` → `build_api.py` to compute diffs, build paginated changelogs, and deploy everything to GitHub Pages.
